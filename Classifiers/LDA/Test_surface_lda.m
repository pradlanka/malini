% Calculate the accurcacy on the test data
parameter_optimized_Decision_Surface=false;
use_accuracy=true;
Currentfolder=pwd;
addpath(genpath(fullfile(Currentfolder,'Classifiers','RCE_Classifiers','LDA','Classifier_Files')));
if(arerce==1);
