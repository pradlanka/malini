...
CurrentFolder = pwd;
addpath(genpath(fullfile(CurrentFolder,'Classifiers','Boosted Stumps','Classifier_Files')));
...
rmpath(genpath(fullfile(CurrentFolder,'Classifiers','Boosted Stumps','Classifier_Files')));
