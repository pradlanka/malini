...
CurrentFolder = pwd;
addpath(genpath(fullfile(CurrentFolder,'Classifiers','Random Forest','Classifier_Files')));
...
rmpath(genpath(fullfile(CurrentFolder,'Classifiers','Random Forest','Classifier_Files')));
