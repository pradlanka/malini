function [Decision_Surf] = muclsfy_slrvarovo_train(x_train, t_train, varargin)
...
% Training Correct
%-----------------------
[t_train_est, ~ ] = calc_label_binary_pair( Xtr, ww, pairs, combine_mode );
...
Decision_Surf=struct('scale',scale, 'base', base, 'ww',ww, 'ix_eff_all',ix_eff_all, 'parm', parm, 'AXall', AXall, 'pairs', pairs);
