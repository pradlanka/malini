...
CurrentFolder = pwd;
addpath(genpath(fullfile(CurrentFolder,'Classifiers','Boosted Trees','Classifier_Files')));
...
rmpath(genpath(fullfile(CurrentFolder,'Classifiers','Boosted Trees','Classifier_Files')));
