if(arerce==0)
Currentfolder=pwd;
addpath(genpath(fullfile(Currentfolder,'Classifiers','Bagged Trees','Classifier_Files')));
...
rmpath(genpath(fullfile(Currentfolder,'Classifiers','Bagged Trees','Classifier_Files')));
cd(fullfile(folder_name,'Outside_Rce_Results',discos));
close(h);
