...
nocl=handles.nocl;
nofo=handles.nofo;
hypelvq=handles.hypelvq;
lowv=str2double(hypelvq{1,1});
incred=str2double(hypelvq{2,1});
uppe=str2double(hypelvq{3,1});
exppara=strcmp('yes',hypelvq{4,1});
...
CurrentFolder = pwd;
addpath(genpath(fullfile(CurrentFolder,'Classifiers','LVQNET','Classifier_Files')));
...
rmpath(genpath(fullfile(CurrentFolder,'Classifiers','LVQNET','Classifier_Files')));
