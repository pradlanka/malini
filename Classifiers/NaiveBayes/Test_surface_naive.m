...
use_accuracy=true;
Currentfolder=pwd;
addpath(genpath(fullfile(Currentfolder,'Classifiers','NaiveBayes','Classifier_Files')));
if(arerce==1)
...
rmpath(genpath(fullfile(Currentfolder,'Classifiers','NaiveBayes','Classifier_Files')));
cd(fullfile(folder_name,'Rce_Results',discos));
close(h);
